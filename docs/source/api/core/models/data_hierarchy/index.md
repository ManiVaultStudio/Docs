...
Plugin developers typically do not need to interact with it directly, as it is fully wrapped by the {ref}`Data Hierarchy Manager <api/core/managers/abstract_data_hierarchy_manager>`.
```
