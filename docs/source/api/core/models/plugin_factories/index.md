...
Plugin factories are used to create instances of plugins. The core also keeps track of which plugin factories are loaded, for which below model classes are used.
