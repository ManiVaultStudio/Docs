...
Actions are re-usable GUI building blocks. During their lifetime, actions are tracked in a global {doc}`api/core/managersactions_manager` with the use of dedicated actions models.
